...
(function () {
	...
	function mount() {
		...
		if (!root) {
			...
			root.className = 'ce-sell-root ce-theme-red';
	...
	function render(root) {
		...
		root.innerHTML = `
			...
			<div class="ce-section">
				...
				<div class="ce-stats" id="ce-sell-stats">
					${[1,2,3,4].map(()=>'<div class="ce-card ce-skeleton-card"></div>').join('')}
				</div>
			</div>

			<div class="ce-section">
				<div class="ce-split">
					<div class="ce-panel ce-panel-tall">
			...
			<div class="ce-section">
				...
				<div class="ce-quick-grid" id="ce-sell-quick"></div>
			</div>
	...
	function renderQuickActions(host) {
		...
		host.innerHTML = items.map(i => `
			<a class="ce-quick ce-quick-rose" href="${i.href}">
	...
	function fmtMoney(v) {
		try { return frappe.format(v || 0, { fieldtype: 'Currency' }); }
